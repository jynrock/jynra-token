...
async function main(){
    ...
    const myKeypair = loadWalletKey("JynUoZkpW1LE9kc7im9UJuRAxxvWyLMmS1uTnGmEcrG.json");
    const mint = new web3.PublicKey("2WxM2KY1ueofL2XpupKpXgs4mrAn6f9Qth3Nt1AxFZpt");
    ...
    const ourMetadata = { // TODO change those values!
        name: "Jynra", 
        symbol: "JNRA",
        uri: "https://raw.githubusercontent.com/jynrock/jynra-token/main/metadata.json",
    }
    if(INITIALIZE){
        const onChainData = {
            ...ourMetadata,
